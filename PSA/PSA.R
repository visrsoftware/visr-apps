...
source("visrutils.R")
source("frequency.R")
#visr.param.directory<-"/Users/hyounesy/Research/Data/edgeR_2016-3-30(18.6)[500]_mydata_5spc"
visr.param.directory<-"/Users/hyounesy/Research/Data/PSA/edgeR_2016-4-14(7.51)[1000]_Jafar_SNwt_ESC_vs_SNcDKO_ESC"
visr.param.mdsColumnIndex<-1
visr.param.summaryUpDown<-"sum_"
    ...
    !file.exists(paste(path,"/allRunsMatrix.txt",sep="")) )
{
  ...
  visr.print("[DONE] Recreate the matrix containing the up/down regulation state for all runs")
	...
	#optimization: delay loading this until neede:
