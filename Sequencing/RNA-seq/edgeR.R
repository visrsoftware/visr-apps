...
# input_group<-"1,1,1,2,2,2"
# #input_method<-"exact test"
# input_method<-"glm"
# input_cpm_cutoff<-0.0
# input_normalizationmethod<-"TMM"
# input_mdsmethod<-"logFC"
# input_n<-20
# input_pvalue<-0.01
# input_adjustmethod<-"BH"
# input_foldchanges<-2.0
# input_pair<-"1,2"
# input_trend<-"none"
# input_ruvseq<-TRUE
# input_ruvn<-5000
# input_coef<-2
# input_contrast<-""
# input_experimentaldesign<-"simple"
# input_prefactor1<-""
# input_prefactor2<-""
