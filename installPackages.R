...
try(visr.biocLite("chromPlot"))
try(visr.biocLite("TxDb.Hsapiens.UCSC.hg19.knownGene"))
try(visr.biocLite("TxDb.Mmusculus.UCSC.mm10.knownGene"))
try(visr.biocLite("GenomicFeatures"))
...
try(visr.library("BiocInstaller"))
try(visr.library("Biobase"))
try(visr.library("DESeq2"))
try(visr.library("pheatmap"))
try(visr.library("PoiClaClu"))
try(visr.library("calibrate"))
try(visr.library("ggrepel"))
try(visr.library("dplyr"))
try(visr.library("genefilter"))
try(#visr.library("AnnotationDbi"))
try(#visr.library("org.Mm.eg.db"))
try(visr.biocLite("edgeR"))
